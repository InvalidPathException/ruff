...
# the issue to capture the deficiency via ranking. That is,
# in ty#1274, the (current) top suggestion is the correct one.
#
# ref: https://github.com/astral-sh/ty/issues/1274#issuecomment-3345923575
AwaiGen<CURSOR: typing.AwaitableGenerator>
